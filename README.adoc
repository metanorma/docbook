...
----
my-book/
├── book.xml              # Main DocBook XML (or article.xml)
├── images/               # Image assets
│   ├── fig-arch.png
│   └── logo.svg
├── resources/            # Additional media
│   └── data.csv
...
----
my-library/
├── library.yml           # Library manifest (or library.json)
├── book-one/
│   ├── book-one.xml      # Book XML
...
| SEO — content visible without JavaScript.
