...
* <<docbook-mirror, DocbookMirror JSON>> -- The ProseMirror-compatible
  intermediate representation: node types, mark types, and how it
  differs from standard ProseMirror.
