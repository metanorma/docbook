...
link:interfaces/cli/build-command[CLI: build] | link:interfaces/ruby-api/single-page[Ruby API: SinglePage]

**Convert DocBook to HTML**::
link:interfaces/cli/convert-command[CLI: convert] | link:interfaces/ruby-api/html-output[Ruby API: HTML Output]
...
. *Explore Features (30 minutes)* -- link:features/html-output/[HTML output], link:features/xinclude/[XInclude], link:features/numbering[Numbering], link:understanding/docbook-mirror/[DocbookMirror JSON]
. *Understand Internals (as needed)* -- link:understanding/architecture[Architecture], link:understanding/data-models[Data Models]

== Getting Help

**Found a bug?**:: link:https://github.com/metanorma/metanorma-docbook/issues[Report an issue on GitHub]
