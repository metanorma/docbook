...
| `Docbook::Output::Html` | Generates static HTML from a parsed document in single-file or directory mode. Powers `docbook convert`.
...
* *<<html-output,HTML Output>>* -- Generating static HTML in single-file and directory modes
