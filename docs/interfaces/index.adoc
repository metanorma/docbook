...
The `docbook` CLI is a Thor-based command-line tool installed with the gem. It provides five commands:
...
4. *Output* -- Generate interactive HTML readers or DocbookMirror JSON
